<title>Detail Riwayat - Sispak Jahit</title>
<?php
...
if ($_GET['id']) {
  ...
  while ($rhasil = mysql_fetch_array($sqlhasil)) {
    $arkerusakan = unserialize($rhasil['kerusakan']);
...
// --------------------- END -------------------------
  ...
  echo "<div class='callout callout-default'>Jenis kerusakan yang dialami adalah <b><h3 class='text text-success'>" . $nmpkt[1] . "</b> / " . round($vlpkt[1], 2) . " % (" . $vlpkt[1] . ")<br></h3>";
