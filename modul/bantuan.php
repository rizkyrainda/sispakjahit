<title>Bantuan - Sispak Jahit</title>
<style>
...
<div class="nav-tabs-custom">
    ...
    <i class="fa fa-envelope-square"></i> Kontak Admin</button><br><br><br><br><br><br>
              ...
              <div class="box-group" id="accordion">
                ...
                <div class="panel box box-primary">
                  ...
                  <div id="collapseOne" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                    <div class="box-body">
					<a href="animasi/bantuan/user/.gif" target="_blank"><img src="animasi/bantuan/user/.gif" alt="Mengakses Menu" /></a><br><br>
                ...
                <div class="panel box box-danger">
                  ...
                  <div id="collapseTwo" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                    <div class="box-body">
                     	<a href="animasi/bantuan/user/.gif" target="_blank"><img src="animasi/bantuan/user/.gif" alt="Mengakses Diagnosa" /></a><br><br>
                     <div style="font-size: 16px;">
					 1. Langkah pertama adalah mengarahkan kursor atau tangan ke bagian menu diagnosa<br>
					 2. Selanjutnya silahkan cari gejala yang di dapati di lapangan.<br>
					 ...
					 6. Hasil Akan di tampilkan dan kerusakan di derita dapat di ketahui.</div>
                    </div>
                  </div>
                </div>
				<div class="panel box box-primary">
                  ...
                  <div id="collapseFour" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
					...
					<a href="animasi/bantuan/user/.gif" target="_blank"><img src="animasi/bantuan/user/.gif" alt="Mengakses Menu" /></a><br><br>
					 ...
					 2. Selanjutnya silahkan cari kerusakan yang dilihat, akan ada tombol detail dan saran di bawahnya<br>
					 3. Tekan tombol detail untuk melihat Detail pada kerusakan, jika sudah anda dapat menutup dengan tanda(x) di atas, atau tombol Close di bawah<br>
					 3. Tekan tombol saran untuk melihat Saran pada kerusakan, jika sudah anda dapat menutup dengan tanda(x) di atas, atau tombol Close di bawah<br>
                    </div></div>
                  </div>
                </div>
				<div class="panel box box-danger">
		 ...
		 <script>
var d = document.getElementById("sispakjahit");
