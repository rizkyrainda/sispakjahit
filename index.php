...
<html><head>
    ...
    <base href="http://localhost/sispakjahit/">
  ...
  <body id="sispakjahit" class="hold-transition skin-purple-light sidebar-mini">
    <div class="wrapper">
      <!-- Main Header -->
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b><i class="fa " aria-hidden="true"></i>SJ</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b><i class="fa " aria-hidden="true"></i>SISPAK JAHIT</b></span>
        </a>
        <!-- Header Navbar -->
                      ...
                      <li class="user-header">
                        ...
                        <p>
                         Login sebagai <?php echo ucfirst($_SESSION['username']); ?>
                          <small>Pakar dari Mesin Jahit</small>
                        </p>
                      </li>
                      <!-- Menu Body -->
                      <li class="user-body">
...
function kirimContactForm(){
    ...
    if(nama.trim() == '' ){
        ...
        <strong><div class="cinta">Copyright © 2022 - Made with <i class="fa fa-heart pulse"></i> by <a href="https://rizkyrainda.blogspot.com/" target="_blank">Rizky Maulana Rainda</a></div></strong>
      </footer>
